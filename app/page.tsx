...
export default function MLeagueApp() {
  ...
  // ပွဲကို Live အဖြစ်ပြောင်းရန် (သို့မဟုတ် ရလဒ်များ တိုက်ရိုက်တင်ရန်)
  const setMatchLive = () => {
  ...
  const finishMatch = () => {
    ...
    setFixtures(updatedFixtures);
    setGoalScorer("");
    alert("ပွဲသိမ်းပြီးဖြစ်၍ အမှတ်ပေးဇယားသို့ အလိုအလျောက် ထည့်သွင်းပြီးပါပြီ။");
  };
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: bgColor, color: textColor, fontFamily: "sans-serif", paddingBottom: "70px", transition: "background 0.3s" }}>
      ...
      <div style={{ padding: "16px", maxWidth: "600px", margin: "0 auto" }}>
        ...
        {activeTab === "results" && (
          <div>
            {/* Live ပွဲများ ရှိလျှင် ထိပ်ဆုံးမှ ပြသပေးမည် */}
          ...
          <div>
            ...
            <div style={{ background: cardBg, padding: "16px", borderRadius: "10px", textAlign: "center", border: "1px solid #334155" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginBottom: "15px" }}>
                ...
                <div style={{ fontSize: "24px", fontWeight: "bold", color: "#ef4444", margin: "5px 0" }}>
                  {homeScore} - {awayScore}
                </div>
